  ...
  return (
    <div className="page" style={{ maxWidth: 1100 }}>
      ...
      >
        <div>
          ...
          <p className="muted" style={{ marginTop: 6, fontSize: 14 }}>
            {total} {showing.toLowerCase()} encontradas
          </p>
        </div>
      </div>
      ...
      >
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
          {[
            ...
            const active =
              (!filterStatus && f.key === 'aberta') || filterStatus === f.key;
            ...
            return (
              <Link
                ...
                href={
                  f.key === 'aberta'
                    ? '/admin/observacoes'
                    : `/admin/observacoes?status=${f.key}`
                }
                className="chip"
                style={{
                  textDecoration: 'none',
        ...
        {clients && clients.length > 0 && (
          <FilterSelect
            ...
            value={filterCliente ?? ''}
            preserveParams={{
              status: filterStatus !== 'aberta' ? filterStatus : undefined,
            }}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        {comments?.map((c) => {
          const author =
            (Array.isArray(c.user_profiles)
              ? c.user_profiles[0]
              : c.user_profiles)?.name ?? 'Usuário';

          const campaign = Array.isArray(c.campaigns)
            ? c.campaigns[0]
            : c.campaigns;

          const item = Array.isArray(c.content_items)
            ? c.content_items[0]
            : c.content_items;
          ...
          return (
            <div
              ...
              style={{
                border: isOpen
                  ? '1px solid var(--orange-100)'
                  : '1px solid var(--line)',
                background: isOpen ? 'var(--orange-50)' : '#fff',
              }}
            >
              <div
                style={{
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    {isOpen ? (
                      <span
                        className="status status-aguardando"
                ...
                >
                  ...
                  {isOpen && <ResolveCommentButton commentId={c.id} />}
                </div>
              </div>
            </div>
          );
